  ...
  const drawer = (
    <div>
      ...
      <List>
        ...
        <ListItem button component={Link} to="/contactus" onClick={() => setMobileOpen(false)}>
          <ListItemIcon><ContactMailIcon color="primary" /></ListItemIcon>
          <ListItemText primary="Contact Us" />
        </ListItem>
        {currentUser && (
          <>
            <ListItem button component={Link} to="/fhir" onClick={() => setMobileOpen(false)}>
              <ListItemIcon><DescriptionIcon color="primary" /></ListItemIcon>
              <ListItemText primary="FHIR" />
            </ListItem>
            <ListItem button component={Link} to="/hl7" onClick={() => setMobileOpen(false)}>
              <ListItemIcon><DescriptionIcon color="primary" /></ListItemIcon>
              <ListItemText primary="HL7" />
            </ListItem>
            <ListItem button component={Link} to="/report" onClick={() => setMobileOpen(false)}>
              <ListItemIcon><DescriptionIcon color="primary" /></ListItemIcon>
              <ListItemText primary="Report" />
            </ListItem>
            <ListItem button component={Link} to="/patients" onClick={() => setMobileOpen(false)}>
        ...
        {showModeratorBoard && (
          <ListItem button component={Link} to="/mod" onClick={() => setMobileOpen(false)}>
            <ListItemIcon><PeopleIcon color="primary" /></ListItemIcon>
